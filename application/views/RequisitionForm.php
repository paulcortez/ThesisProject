...
<?php echo form_open('UserRequest/new_request');?>
   ...
   <form name="addItem" method="post" action="<?php echo site_url('UserRequest/add_item')?>">		
      ...
      <table class="table">
            <thead>
              <tr>
                <th scope="col"class="col-lg-4 col-sm-8" ><h4>Item Name</h4></th>
                <th scope="col" class="col-lg-4 col-sm-8"><h4>Description</h4></th>
                <th scope="col" class="col-lg-4 col-sm-8"><h4>Unit</h4></th>
                <th scope="col" class="col-lg-4 col-sm-8"><h4>Quantity</h4></th>
              </tr>
            </thead>
            <tbody>
